...
class LoginPage:
    ...
    def forgot_password(self):
             ms.showinfo('Forgot Password', 'Please consult higher authorities for password recovery.')



    def sign_up(self):
        ms.showinfo('Sign Up', 'Please consult higher authorities for creating a new account.')
    def __init__(self, window):
        ...
        self.forgot_button = Button(self.lgn_frame, text="Forgot Password ?",
                                    ...
                                    , borderwidth=0, background="#040405", cursor="hand2",command=self.forgot_password)
        ...
        self.signup_button_label = Button(self.lgn_frame, image=self.signup_img, bg='#98a65d', cursor="hand2",
                                          borderwidth=0, background="#040405", activebackground="#040405",command=self.sign_up)
